...
public class ChatGPTService {
    ...
    public String askChatGPT(String userMessage) {
        try {
            ...
            ChatGPTRequest.Message systemMessage = new ChatGPTRequest.Message("system", "Bạn là một trợ lý hỗ trợ khách hàng tìm vé xe. Tôi sẽ đưa cho bạn danh sách các tuyến đường, nhiệm vụ của bạn là đưa ra tuyến đường đang hoạt động hợp lý trong danh sách theo format \"departureLocation - arrivalLocation\" (không có dấu ngoặc kép). Nếu khách hàng đang ở vị trí không liên quan đến tuyến đường mà khách hàng muốn nhưng khách nếu hàng cung cấp đầy đủ \"departureLocation - arrivalLocation\" (ví dụ \"Thành Phố A đến thành phố B\") thì vẫn trả về cho khách hàng đúng tuyến đường đó nếu nó có tồn tại trong danh sách tuyến đường. Nếu tuyến đường khách hàng muốn là \"arrivalLocation - departureLocation\" (tuyến đường bị đảo ngược) thì trả về \"Tuyến đường không tồn tại\". Nếu tuyến đường không tồn tại trong danh sách thì trả về \"Tuyến đường không tồn tại\".\n "+
                    "Đây là danh sách các tuyến đường:\n" + routesJson);
